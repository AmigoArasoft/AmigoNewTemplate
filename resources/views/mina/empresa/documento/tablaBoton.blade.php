<div class="hstack gap-2 fs-15">
	@if (substr(URL::current(), 0, 16) == 'http://localhost')
		<a class="btn btn-sm btn-info" href="../../storage/app/{{ $archivo }}" target="blank"><i class="fas fa-download"></i> Descargar</a>
	@else
		<a class="btn btn-sm btn-info" href="{{ route('storage.download', substr($archivo, 17)) }}" target="blank"><i class="fas fa-download"></i> Descargar</a>
	@endif
