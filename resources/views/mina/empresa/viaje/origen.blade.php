...
<body>
    ...
    <<p class="texto10">Para verificar la autenticidad del presente Certificado de Orígen por favor consulte: <a href="https://garzonromero.com/amigo/origen?id={{ $dato->id }}" target="_blank">https://garzonromero.com/amigo/origen?id={{ $dato->id }}</a></p>
</body>
</html>